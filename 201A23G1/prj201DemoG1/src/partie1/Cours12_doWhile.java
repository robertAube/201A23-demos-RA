...
public class Cours12_doWhile {
    ...
    private void appuyerSurEnterPourContinuer_dowhile() {
        ...
        do { //Entre au moins une fois dans la boucle
    ...
    private void appuyerSurEnterPourContinuer_while() {
        ...
        while (!strSaisie.equals("")) { //On n'est pas certain d'entrer dans la boucle
            strSaisie = lireString("Vous avaez appuyé sur \"" + strSaisie + "\"SVP appuyez sur 'Entrée' seulement : ");
        }
